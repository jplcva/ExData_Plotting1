...
## The function's output is the "plot4.png" file in the working directory.
...
plot4 <- function(workDir = "")
{
        ...
        ## the default width (480) and height (480). Open the plot4.png file in
        ## the working directory
        png(file = "./plot4.png", bg = "transparent")
        
        ## Set the graphics device to draw 4 graphs on 2 rows and 3 columns
        par(mfrow = c(2, 2))

        ## Plot the 1st line graph with the Date/Time on the X-axis and the
        ## Global_active_power on the Y-axis. The axes labels are set to the
        ## requirement
        with(df, plot(Time, Global_active_power, type = "l",
                      xlab = "", ylab = "Global Active Power"))

        ## Plot the 2nd line graph with the Date/Time on the X-axis and the
        ## Voltage on the Y-axis. The axes labels are set to the requirement
        with(df, plot(Time, Voltage, type = "l",
                      xlab = "datetime", ylab = "Voltage"))

        ## Plot the 3rd line graph with the Date/Time on the X-axis and the 3
        ...
        ## "blue" for Sub_metering_3. The "topright" legend box has no border
        ...
        ## Plot the 4th line graph with the Date/Time on the X-axis and the
        ## Global_reactive_power on the Y-axis. The axes labels are set to the
        ## requirement
        with(df, plot(Time, Global_reactive_power, type = "l",
                      xlab = "datetime"))

        ## Set the graphics device back to 1 row and 1 column
        par(mfrow = c(1, 1))
