...
## This function performs the first plot required for the course project 1. The
## function operates in the given directory, unless one is given as a parameter.
## The function's output is the "plot1.png" file in the working directory.
...
plot1 <- function(workDir = "")
{
        ...
        ## the default width (480) and height (480). Open the plot1.png file in
        ## the working directory
        png(file = "./plot1.png", bg = "transparent")

        ## Compute the historgram on the Global_active_power column in red, and
        ## set the graph's main title and the label on the X-axis
